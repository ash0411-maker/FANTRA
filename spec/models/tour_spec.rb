...
RSpec.describe Tour, type: :model do
    ...
    describe 'Tourバリデーションのテスト' do
    	...
    	context 'bodyカラム' do
		    it '400文字以内であること' do
		      tour.body = Faker::Lorem.characters(number:401)
		      expect(tour.valid?).to eq false;
		    end
		    it '空欄でないこと' do
		      tour.body = ''
    	...
    	context 'meetingpoint_introductionカラム' do
		    it '200文字以内であること' do
		      tour.meetingpoint_introduction = Faker::Lorem.characters(number:201)
		      expect(tour.valid?).to eq false;
		    end
		    it '空欄でないこと' do
    ...
    describe 'Tourアソシエーションのテスト' do
		...
		context 'Commentモデルとの関係' do
		  it '1:Nとなっている' do
		    expect(Tour.reflect_on_association(:comments).macro).to eq :has_many
		  end
		end
